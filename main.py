...
def index():
    ...
    return render_template('index.html', bedrooms=bedrooms, bathrooms=bathrooms, neighborhoods=neighborhoods, years_built=years_built)
...
def predict():
    try:
        ...
        print(f"Received form data: Bedrooms={bedrooms}, Bathrooms={bathrooms}, SquareFeet={square_feet}, Neighborhood={neighborhood}, YearBuilt={year_built}")
        ...
        input_data = pd.DataFrame([[square_feet, bedrooms, bathrooms, year_built]],
